...
*Last updated: 2026-09-01 (Phases 0–23 complete; humanoid and full-robot system synthesis shipped and verified live; post-ship hardening commit `87c8f7b` fixes the rule-based robot arm layout; 357/357 tests passing; Phase 24 world-model simulation builder is next)*
