...
def get_capabilities() -> dict[str, object]:
    ...
    return {
        ...
        "endpoints": {
            ...
            "hermes_session": "POST /hermes/session",
            "hermes_message": "POST /hermes/session/{id}/message",
            "hermes_approve": "POST /hermes/session/{id}/approve",
            "hermes_explain": "POST /hermes/session/{id}/explain",
            "hermes_status": "GET /hermes/session/{id}/status",
