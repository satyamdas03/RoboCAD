...
- Feature-tree backend, sketch constraint solver, assembly system, DFM/tolerance/FEA verification, domain classification, automatic decomposition, mechanical assembly synthesis, aero/thermal/propulsion geometry, and electronics/mechatronics co-design all implemented and tested.
...
- Phase 22 — multi-physics verification engine — is the next build target.
