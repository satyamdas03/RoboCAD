...
>
> **Latest milestone:** Phases 0–**28A/B/C/D/E/F** are complete, **Phase 29–30** are delivered, and **Milestones A–B** are closed. RoboCAD now has a **one-command launcher and health CLI** (28A), an **asset marketplace** (28B), a **deep multi-physics engine** (28C), a **morphology co-design lab** (28D), **simulation certification** (28E), **product hardening** (28F), **physics-based morphology scoring** (29), **real gait synthesis** (30), **adaptive gait robustness** (Milestone A), and **structural dynamics / FEA for links** (Milestone B). The full pytest suite: **380 default + 246 heavy/slow tests passing** (1 expected failure, 5 benchmark/network tests deselected); frontend production build passes. Phase 27D (hardware-in-the-loop sim-to-real) remains future work blocked on hardware access.
